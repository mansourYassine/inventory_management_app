...
$routes = [
    ...
    '/stock_movements/add'  => CONTROLLERS_PATH . 'stock_movement.controller.php',
    '/stock_movements/info' => CONTROLLERS_PATH . 'stock_movement.controller.php',
    '/stock_movements/edit' => CONTROLLERS_PATH . 'stock_movement.controller.php',
];
