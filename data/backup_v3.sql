...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 03, 2025 at 11:09 PM
...
(1, 'Ceramic Floor Tile 30x30', 1, 1, 500, 45.00, 'YES'),
(2, 'Porcelain Wall Tile 20x40', 1, 2, 300, 65.00, 'YES'),
(3, 'Mosaic Tile Sheet', 1, 3, 150, 120.00, 'YES'),
(4, 'Granite Slab 60x60', 2, 1, 80, 350.00, 'YES'),
(5, 'Chocop', 2, 1, 300, 1.50, 'YES'),
(6, 'Cement Bag 50kg', 3, NULL, 1000, 70.00, 'YES'),
(7, 'Genova', 2, NULL, 800, 2.50, 'YES'),
(8, 'Grout Powder White 10kg', 3, 5, 600, 55.00, 'NO'),
(9, 'Electric Tile Cutter', 4, 6, 25, 1200.00, 'YES'),
(10, 'Rubber Mallet', 4, 6, 100, 75.00, 'YES'),
(11, 'Danone', 4, 3, 500, 2.00, 'YES'),
(12, 'Merandina', 2, 3, 700, 2.50, 'YES');
...
(7, 'Hicham', 'hicham@gmail.com', '0747859612', 'Deroua, Morocco');
